...
export type HookTransformFn = (ctx: HookMappingContext) => HookTransformResult | Promise<HookTransformResult>;
...
export interface WebhooksExtension {
  ...
  testMapping(mappingId: string, payload: Record<string, unknown>): Promise<HookMappingResult | null>;
}
